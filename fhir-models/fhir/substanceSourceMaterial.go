...
type SubstanceSourceMaterial struct {
	...
	OrganismNameElement         *PrimitiveElement                            `bson:"_organismName,omitempty" json:"_organismName,omitempty"`
	...
	ParentSubstanceNameElement  []*PrimitiveElement                          `bson:"_parentSubstanceName,omitempty" json:"_parentSubstanceName,omitempty"`
	...
	GeographicalLocationElement []*PrimitiveElement                          `bson:"_geographicalLocation,omitempty" json:"_geographicalLocation,omitempty"`
...
type SubstanceSourceMaterialFractionDescription struct {
	...
	FractionElement   *PrimitiveElement `bson:"_fraction,omitempty" json:"_fraction,omitempty"`
...
type SubstanceSourceMaterialOrganism struct {
	...
	IntraspecificDescriptionElement *PrimitiveElement                               `bson:"_intraspecificDescription,omitempty" json:"_intraspecificDescription,omitempty"`
...
type SubstanceSourceMaterialOrganismAuthor struct {
	...
	AuthorDescriptionElement *PrimitiveElement `bson:"_authorDescription,omitempty" json:"_authorDescription,omitempty"`
}
type SubstanceSourceMaterialOrganismHybrid struct {
	...
	MaternalOrganismIdElement   *PrimitiveElement `bson:"_maternalOrganismId,omitempty" json:"_maternalOrganismId,omitempty"`
	MaternalOrganismName        *string           `bson:"maternalOrganismName,omitempty" json:"maternalOrganismName,omitempty"`
	MaternalOrganismNameElement *PrimitiveElement `bson:"_maternalOrganismName,omitempty" json:"_maternalOrganismName,omitempty"`
	PaternalOrganismId          *string           `bson:"paternalOrganismId,omitempty" json:"paternalOrganismId,omitempty"`
	PaternalOrganismIdElement   *PrimitiveElement `bson:"_paternalOrganismId,omitempty" json:"_paternalOrganismId,omitempty"`
	PaternalOrganismName        *string           `bson:"paternalOrganismName,omitempty" json:"paternalOrganismName,omitempty"`
	PaternalOrganismNameElement *PrimitiveElement `bson:"_paternalOrganismName,omitempty" json:"_paternalOrganismName,omitempty"`

...
type RiskAssessment struct {
	...
	MitigationElement         *PrimitiveElement          `bson:"_mitigation,omitempty" json:"_mitigation,omitempty"`
...
type RiskAssessmentPrediction struct {
	...
	ProbabilityDecimalElement *PrimitiveElement `bson:"_probabilityDecimal,omitempty" json:"_probabilityDecimal,omitempty"`
	...
	RelativeRiskElement       *PrimitiveElement `bson:"_relativeRisk,omitempty" json:"_relativeRisk,omitempty"`

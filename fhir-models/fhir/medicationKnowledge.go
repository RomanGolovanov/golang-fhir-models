...
type MedicationKnowledge struct {
	...
	SynonymElement                []*PrimitiveElement                             `bson:"_synonym,omitempty" json:"_synonym,omitempty"`
	...
	PreparationInstructionElement *PrimitiveElement                               `bson:"_preparationInstruction,omitempty" json:"_preparationInstruction,omitempty"`
...
type MedicationKnowledgeRegulatorySubstitution struct {
	...
	AllowedElement    *PrimitiveElement `bson:"_allowed,omitempty" json:"_allowed,omitempty"`
}
